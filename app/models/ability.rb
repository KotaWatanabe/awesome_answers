...
class Ability
  ...
  # Cancancan suumes you have a method called 'current_user' is available in your 
  # ApplicationsCOntoroller(which we do). Cancancan gets automatically initilaized
  ...
  def initialize(user)
    ...
    # in this case, we are saying if the signed in user id is the same as question id
    # then allow 'editing' the question.
    # IMPORTANT: difining a rule a rule 
